...
import { WorkflowStep } from "../core/WorkflowEngine";
...
export class ProgressPanel implements vscode.WebviewViewProvider {
  public static readonly viewType = "deployflow.progressPanel";
  private _view?: vscode.WebviewView;
  private _extensionUri: vscode.Uri;
  private _messages: ProgressUpdate[] = [];
  ...
  private _postUpdate(update: ProgressUpdate): void {
  ...
  private _getHtml(nonce: string, webview: vscode.Webview): string {
