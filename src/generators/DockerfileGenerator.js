...
class DockerfileGenerator {
    ...
    async generate(projectInfo) {
        ...
        await this.fileUtils.writeFile(path.join(projectInfo.rootPath, "Dockerfile"), dockerfile);
        // Generate .dockerignore (tells Docker which files to skip)
        const dockerignore = this.generateDockerignore(projectInfo);
        await this.fileUtils.writeFile(path.join(projectInfo.rootPath, ".dockerignore"), dockerignore);
...
`;
    ...
    generateGenericDockerfile(info) {
