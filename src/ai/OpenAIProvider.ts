...
// Shape of what OpenAI API returns
        ...
        messages: [
          {
            role: "system",
            content:
              "You are an expert DevOps engineer and software developer. You provide precise, working solutions to build and deployment problems.",
          },
          {
            role: "user",
            content: prompt,
